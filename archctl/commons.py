...
def get_repo_dataclass(input_repo: str | Repo) -> Repo:
    """
...
def get_template_version_dataclass(
    input_template: str, template_repo: Repo
) -> TemplateVersion:
    """
    ...
    template_repo = get_repo_dataclass(template_repo)
...
def auth_status():
    ...
    try:
        ...
        logger.error(
            "User is not logged in GitHub CLI, please log in before using archctl"
        )
        exit(1)
